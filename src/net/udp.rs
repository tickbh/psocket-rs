...
/// an unordered, unreliable protocol; refer to [`TcpSocket`] and [`TcpSocket`] for TCP
/// primitives.
///
/// [`bind`]: #method.bind
...
impl UdpSocket {
    ...
    ///
    /// ```no_run
    /// use psocket::{SocketAddr, UdpSocket};
    ///
    /// let addrs = [
    ...
    ///
    /// ```no_run
    /// use psocket::{Ipv4Addr, SocketAddr, SocketAddrV4, UdpSocket};
    ///
    /// let socket = UdpSocket::bind("127.0.0.1:34254").expect("couldn't bind to address");
