...
///
/// [IP address]: ../../pscoket/net/enum.IpAddr.html
/// [`SocketAddrV4`]: ../../pscoket/net/struct.SocketAddrV4.html
/// [`SocketAddrV6`]: ../../pscoket/net/struct.SocketAddrV6.html
///
/// # Examples
///
/// ```
/// use psocket::{IpAddr, Ipv4Addr, SocketAddr};
///
...
/// [IPv4 address]: ../../pscoket/net/struct.Ipv4Addr.html
/// [`SocketAddr`]: ../../pscoket/net/enum.SocketAddr.html
///
/// # Examples
///
/// ```
/// use psocket::{Ipv4Addr, SocketAddrV4};
///
...
/// [IPv6 address]: ../../pscoket/net/struct.Ipv6Addr.html
/// [`SocketAddr`]: ../../pscoket/net/enum.SocketAddr.html
///
/// # Examples
///
/// ```
/// use psocket::{Ipv6Addr, SocketAddrV6};
///
...
impl SocketAddr {
    ...
    /// [IP address]: ../../pscoket/net/enum.IpAddr.html
    /// [IPv4 address]: ../../pscoket/net/enum.IpAddr.html#variant.V4
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`false`]: ../../std/primitive.bool.html
    /// [IP address]: ../../pscoket/net/enum.IpAddr.html
    /// [IPv6 address]: ../../pscoket/net/enum.IpAddr.html#variant.V6
    ///
    /// # Examples
    ///
    /// ```
    /// use psocket::{IpAddr, Ipv6Addr, SocketAddr};
    ///
    /// fn main() {
...
impl SocketAddrV4 {
    ...
    ///
    /// ```
    /// use psocket::{SocketAddrV4, Ipv4Addr};
    ///
    /// let socket = SocketAddrV4::new(Ipv4Addr::new(127, 0, 0, 1), 8080);
    /// ```
...
impl SocketAddrV6 {
    ...
    ///
    /// ```
    /// use psocket::{SocketAddrV6, Ipv6Addr};
    ///
...
///
/// This trait allows constructing network objects like [`TcpSocket`] or
...
/// [`IpAddr`]: ../../pscoket/net/enum.IpAddr.html
/// [`Ipv4Addr`]: ../../pscoket/net/struct.Ipv4Addr.html
/// [`Ipv6Addr`]: ../../pscoket/net/struct.Ipv6Addr.html
/// [`SocketAddr`]: ../../pscoket/net/enum.SocketAddr.html
/// [`SocketAddrV4`]: ../../pscoket/net/struct.SocketAddrV4.html
/// [`SocketAddrV6`]: ../../pscoket/net/struct.SocketAddrV6.html
...
/// [`UdpSocket`]: ../../pscoket/net/struct.UdpSocket.html
...
///
/// ```
/// use psocket::{ToSocketAddrs, SocketAddr};
///
...
///
/// ```no_run
/// use psocket::{SocketAddr, ToSocketAddrs};
///
...
/// ```
///
/// [`TcpSocket::connect`] is an example of an function that utilizes
/// `ToSocketsAddr` as a trait bound on its parameter in order to accept
/// different types:
///
/// ```no_run
/// use psocket::{TcpSocket, Ipv4Addr};
///
/// let stream = TcpSocket::connect(("127.0.0.1", 443));
/// // or
/// let stream = TcpSocket::connect("127.0.0.1:443");
/// // or
/// let stream = TcpSocket::connect((Ipv4Addr::new(127, 0, 0, 1), 443));
/// ```
///
/// [`TcpSocket::connect`]: ../../pscoket/net/struct.TcpSocket.html#method.connect
